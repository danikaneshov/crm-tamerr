          ...
          <div className="grid grid-cols-3 gap-3 w-full max-w-[280px]">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
              <button
                ...
                className="h-16 bg-white/80 rounded-2xl text-2xl font-black text-slate-800 border-none smooth-shadow active:scale-90 hover:-translate-y-1 transition-all flex items-center justify-center touch-manipulation"
              >
                {num}
              </button>
            ))}
            ...
            <button
              ...
              className="h-16 bg-white/50 rounded-2xl text-slate-500 border-none active:scale-90 transition-all flex items-center justify-center hover:bg-red-50 hover:text-red-500 touch-manipulation"
            >
              <Delete size={24} />
            </button>
          </div>
