...
const ShiftsTab = () => {
 ...
 <div className="bg-white backdrop-blur-xl w-full lg:max-w-lg rounded-t-[32px] lg:rounded-[32px] p-6 lg:p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto relative pb-safe">
