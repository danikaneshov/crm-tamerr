  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex bg-white/60 p-1 rounded-2xl w-full sm:w-auto shadow-sm border border-slate-100">
      ...
      {operationType === 'in' && (
        <div className="space-y-8">
          ...
          {invCart.length > 0 && (
            <div className="bg-white/80 backdrop-blur-xl rounded-[32px] border-none smooth-shadow p-6">
              <h2 className="text-lg font-black text-slate-800 mb-6">Корзина прихода</h2>
              <div className="space-y-4">
                {invCart.map((item, index) => (
                  <div key={item.id} className="flex flex-col md:flex-row items-start md:items-center gap-4 p-4 border border-slate-100 rounded-2xl bg-slate-50/50">
      ...
      {operationType === 'writeoff' && (
        <div className="space-y-6">
          <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[40px] border-none smooth-shadow max-w-xl">
