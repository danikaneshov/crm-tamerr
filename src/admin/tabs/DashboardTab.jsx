  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-green-500 to-emerald-700 p-8 rounded-[32px] shadow-lg shadow-green-200 text-white relative overflow-hidden md:col-span-2 hover:-translate-y-1 transition-all">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-between relative z-10">
            <div>
              <p className="font-bold text-sm uppercase tracking-widest mb-2 opacity-80 text-green-100">Чистая прибыль</p>
              <h3 className="text-4xl font-black">{formatMoney(dashboardNetProfit)} ₸</h3>
              <p className="text-sm opacity-80 mt-2 text-green-50">Вычеты: ЗП ({formatMoney(totalSystemEarned)} ₸)</p>
            </div>
            <div className="text-right sm:mt-0 mt-4">
              <p className="font-bold text-xs uppercase tracking-widest mb-1 opacity-80 text-green-100">Грязная прибыль</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* График ЗП */}
        <div className="bg-white/90 border border-white p-8 rounded-[40px] smooth-shadow">
      ...
      <div className="bg-white/90 border border-white p-8 rounded-[40px] smooth-shadow">
        ...
        <div className="space-y-4">
          {dashboardProfitByMaster.map((emp, index) => (
            <div key={emp.id} className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-slate-100 hover:bg-white transition-all hover:shadow-md hover:-translate-y-1">
              <div className="flex items-center gap-4">
