...
const Card = React.forwardRef(({ className = '', variant = 'default', children, ...props }, ref) => {
  ...
  const variants = {
    ...
    elevated: 'bg-white/90 backdrop-blur-xl border border-white smooth-shadow transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl',
    ...
    outline: 'bg-transparent border-2 border-slate-200/50',
