...
const EmployeeApp = () => {
 ...
 return (
 <div className="h-[100dvh] w-full bg-gradient-to-b from-neutral-50 to-primary-light/30 flex flex-col items-center justify-center p-4 transition-colors">
 <Card variant="elevated" className="w-full max-w-sm p-8 flex flex-col items-center border-0 shadow-2xl ">
 <div className="mb-10 text-center">
 <h1 className="text-3xl font-black tracking-tight text-slate-900 ">ERP<span className="text-primary">.</span></h1>
 <p className="text-slate-400 text-sm mt-2 font-medium">Введите ваш PIN-код</p>
 </div>
 ...
 className="h-16 bg-white text-2xl font-bold rounded-2xl shadow-sm border border-slate-100 text-slate-800 btn-hover-effect"
 >
 {n}
 </button>
 ))}
 ...
 className="h-16 bg-slate-50 text-slate-400 font-bold rounded-2xl border border-slate-100 btn-hover-effect text-sm"
 >
 DEL
 </button>
 </div>
 ...
 <div className="w-16 h-16 bg-emerald-900/30 text-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4"><CheckCircle2 size={32} /></div>
 ...
 <Badge variant="dark" className="bg-white text-white animate-pulse"><div className="w-2 h-2 rounded-full bg-white mr-2"></div>Смена идет</Badge>
